...
func (m *AccountPlanMutation) AddModuleIDs(ids ...uuid.UUID) {
	if m.modules == nil {
...
func (m *AccountPlanMutation) RemovedModulesIDs() (ids []uuid.UUID) {
...
func (m *AccountPlanMutation) ModulesIDs() (ids []uuid.UUID) {
...
func (m *AccountPlanMutation) ResetModules() {
	m.modules = nil
...
func (m *AccountPlanMutation) AddedEdges() []string {
	...
	if m.modules != nil {
		edges = append(edges, accountplan.EdgeModules)
	}
	return edges
}
...
type ModuleMutation struct {
	...
	created_at           *time.Time
	clearedFields        map[string]struct{}
	account_plans        map[uuid.UUID]struct{}
	removedaccount_plans map[uuid.UUID]struct{}
	clearedaccount_plans bool
	done                 bool
...
// SetActive sets the "active" field.
func (m *ModuleMutation) SetActive(b bool) {
	m.active = &b
}

// Active returns the value of the "active" field in the mutation.
func (m *ModuleMutation) Active() (r bool, exists bool) {
	v := m.active
	if v == nil {
		return
	}
...
// OldActive returns the old "active" field's value of the Module entity.
// If the Module object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ModuleMutation) OldActive(ctx context.Context) (v bool, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldActive is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetActive resets all changes to the "active" field.
func (m *ModuleMutation) ResetActive() {
	m.active = nil
}
...
func (m *ModuleMutation) AddAccountPlanIDs(ids ...uuid.UUID) {
	if m.account_plans == nil {
		m.account_plans = make(map[uuid.UUID]struct{})
	}
	for i := range ids {
		m.account_plans[ids[i]] = struct{}{}
	}
}

// ClearAccountPlans clears the "account_plans" edge to the AccountPlan entity.
func (m *ModuleMutation) ClearAccountPlans() {
	m.clearedaccount_plans = true
}

// AccountPlansCleared reports if the "account_plans" edge to the AccountPlan entity was cleared.
func (m *ModuleMutation) AccountPlansCleared() bool {
	return m.clearedaccount_plans
}

// RemoveAccountPlanIDs removes the "account_plans" edge to the AccountPlan entity by IDs.
func (m *ModuleMutation) RemoveAccountPlanIDs(ids ...uuid.UUID) {
	if m.removedaccount_plans == nil {
		m.removedaccount_plans = make(map[uuid.UUID]struct{})
	}
	for i := range ids {
		delete(m.account_plans, ids[i])
		m.removedaccount_plans[ids[i]] = struct{}{}
	}
}

// RemovedAccountPlans returns the removed IDs of the "account_plans" edge to the AccountPlan entity.
func (m *ModuleMutation) RemovedAccountPlansIDs() (ids []uuid.UUID) {
	for id := range m.removedaccount_plans {
		ids = append(ids, id)
	}
	return
}

// AccountPlansIDs returns the "account_plans" edge IDs in the mutation.
func (m *ModuleMutation) AccountPlansIDs() (ids []uuid.UUID) {
	for id := range m.account_plans {
		ids = append(ids, id)
	}
	return
}

// ResetAccountPlans resets all changes to the "account_plans" edge.
func (m *ModuleMutation) ResetAccountPlans() {
	m.account_plans = nil
	m.clearedaccount_plans = false
	m.removedaccount_plans = nil
}
...
func (m *ModuleMutation) Fields() []string {
	...
	if m.active != nil {
		fields = append(fields, module.FieldActive)
	}
	if m.created_at != nil {
...
func (m *ModuleMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.account_plans != nil {
		edges = append(edges, module.EdgeAccountPlans)
	}
	return edges
}
...
func (m *ModuleMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case module.EdgeAccountPlans:
		ids := make([]ent.Value, 0, len(m.account_plans))
		for id := range m.account_plans {
			ids = append(ids, id)
		}
		return ids
...
func (m *ModuleMutation) RemovedIDs(name string) []ent.Value {
	switch name {
	case module.EdgeAccountPlans:
		ids := make([]ent.Value, 0, len(m.removedaccount_plans))
		for id := range m.removedaccount_plans {
			ids = append(ids, id)
		}
		return ids
