...
func (_u *ProductUpdate) SetCostPrice(v float64) *ProductUpdate {
...
func (_u *ProductUpdate) SetNillableCostPrice(v *float64) *ProductUpdate {
	if v != nil {
		_u.SetCostPrice(*v)
	}
	return _u
...
func (_u *ProductUpdate) AddCostPrice(v float64) *ProductUpdate {
...
func (_u *ProductUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AddedCostPrice(); ok {
		_spec.AddField(product.FieldCostPrice, field.TypeFloat64, value)
	}
...
// SetCostPrice sets the "cost_price" field.
func (_u *ProductUpdateOne) SetCostPrice(v float64) *ProductUpdateOne {
	_u.mutation.ResetCostPrice()
	_u.mutation.SetCostPrice(v)
	return _u
}
...
// SetNillableCostPrice sets the "cost_price" field if the given value is not nil.
func (_u *ProductUpdateOne) SetNillableCostPrice(v *float64) *ProductUpdateOne {
	if v != nil {
		_u.SetCostPrice(*v)
	}
	return _u
...
// AddCostPrice adds value to the "cost_price" field.
func (_u *ProductUpdateOne) AddCostPrice(v float64) *ProductUpdateOne {
	_u.mutation.AddCostPrice(v)
	return _u
}
