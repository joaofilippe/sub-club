...
func (_c *CustomerCreate) SetNillableDocument(v *string) *CustomerCreate {
	if v != nil {
		_c.SetDocument(*v)
	}
	return _c
...
func (_c *CustomerCreate) SetAddress(v *schema.Address) *CustomerCreate {
...
func (_c *CustomerCreate) AddSubscriptionIDs(ids ...uuid.UUID) *CustomerCreate {
	_c.mutation.AddSubscriptionIDs(ids...)
	return _c
}

// AddSubscriptions adds the "subscriptions" edges to the Subscription entity.
func (_c *CustomerCreate) AddSubscriptions(v ...*Subscription) *CustomerCreate {
