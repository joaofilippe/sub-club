...
### Fake Data Seeder
Runs automatically on startup when `APP_ENV` is `development` or `local`, and only if the database is empty. Seeds 1 admin, 10 products, 4 plans, 50 customers, 25 subscriptions.
